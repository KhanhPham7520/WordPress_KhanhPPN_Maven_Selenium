...
public class TC_Account_Login extends AbstractTest {
	...
	public void TC_02_Login_Not_Exist_Username() {
		...
		verifyEquals(loginPO.getTextValidationErrorMsg(driver), "User does not exist. Would you like to create a new account?");
	...
	public void TC_03_Login_With_Invalid_Password() {
		...
		verifyEquals(loginPO.getTextValidationErrorMsg(driver), "Oops, that's not the right password. Please try again!");
